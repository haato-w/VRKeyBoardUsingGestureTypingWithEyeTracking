...
public class EyeGazeController : MonoBehaviour
{
    ...
    private TextMesh SpaceKeyTextComp;
    ...
    private List<string> exapleSentencesList = ExampleSentences.EyeGazeGestureExampleSentencesForPractice;
    ...
    void Start()
    {
        ...
        SpaceKeyTextComp = SpaceKeyTextObj.GetComponent<TextMesh>();
        ...
        eyeLinerend.widthMultiplier = 0.001f;
        eyeLinerend.startColor = Color.clear;
        eyeLinerend.endColor = Color.clear;
        ...
        LineRendererOnCanvas.SetPosition(LineRendererOnCanvas.positionCount - 1, new Vector3(0, 0, -5));
    ...
    void Update() {
        ...
        // LineRendererで視線を引く
        eyeLinerend.SetPosition(0, eyeGaze.transform.position); eyeLinerend.SetPosition(1,  oculusCamPos + eyeGaze.transform.forward * 50);
        ...
        // スペースキーの色を黒に戻す
        SpaceKeyTextComp.color = Color.black;
        ...
        if (Physics.Raycast(ray, out hit, 100))
        {
            ...
            // 候補ワードである場合
            if (gameObject.CompareTag("CandidateWordLeft")) {
